...
test('the core reaches only the modules that are also portable', () => {
  ...
  assert.deepEqual(files.sort(), ['address.js', 'app.js', 'cache.js', 'cookies.js', 'csp.js', 'document.js', 'extract.js', 'feed.js', 'include.js', 'negotiate.js', 'proxy.js', 'rewrite.js', 'server.js', 'sitemap.js']);
});
