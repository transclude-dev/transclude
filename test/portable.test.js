...
test('the core reaches only the modules that are also portable', () => {
  ...
  assert.deepEqual(files.sort(), ['address.js', 'after.js', 'app.js', 'cache.js', 'cookies.js', 'csp.js', 'defaults.js', 'document.js', 'extract.js', 'feed.js', 'gate.js', 'include.js', 'negotiate.js', 'permissions.js', 'precache.js', 'proxy.js', 'rewrite.js', 'server.js', 'sitemap.js']);
});
