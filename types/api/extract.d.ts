 ...
 */
export declare function readDocument(html: string): object;
/**
 ...
 */
export declare function indexDocument(root: object): object;
/**
 ...
 */
export declare function resolveFragment(input: string | object, id: string): {
    id: string;
    implicit: boolean;
    nodes: object[];
    html: string;
 ...
 */
export declare function listFragments(input: string | object): Array<{
    id: string;
    implicit: boolean;
    tag: string;
    rank: number;
